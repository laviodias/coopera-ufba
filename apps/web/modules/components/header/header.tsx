              ...
              <div className="flex gap-2">
                  ...
                  <PopoverContent>
                    {
                      notifications.length > 0 ?
                        <>
                              ...
                              notifications.map(notification => (
                                <>
                                  <li key={notification.id} className="flex flex-col">
                                    <Link href={`/notificacao/${notification.id}`} className="text-sm hover:underline">{notification.title}</Link>
                                    <small className="text-blue-light text-xs">{formatDistanceToNow(notification.datetime, { locale: ptBR })}</small>
                                  </li>
                                  <Separator />
                                </>
                              ))
                          ...
                          <Link href={'notificacao'} className="text-center text-sm text-blue-light block pt-4 hover:text-blue-strong hover:underline">Ver mais</Link>
                        </>
                        :
                ...
                <Popover>
                  ...
                  <PopoverContent className="grid gap-2">
                    <Link href={"/"} className="font-medium hover:underline">Meu Perfil</Link>
                    <Link href={"/"} className="font-medium hover:underline">Sair</Link>
                  </PopoverContent>
                </Popover>
              </div>
          }
